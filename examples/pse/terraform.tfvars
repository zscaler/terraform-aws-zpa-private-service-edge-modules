...
#####################################################################################################################
##### Variables 5-15 are populated automatically if terraform is ran via ZSPSE bash script.  ##### 
...
## 15. By default, terraform will always query the AWS Marketplace for the latest Private Service Edge AMI available.
...
## 19. Provide your existing Service Edge private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
## 24. By default, this script will create new IAM roles, policy, and Instance Profiles for the Service Edge
...
## 26. By default, this script will create new Security Groups for the Service Edge interface
